    ...
    return (
        <div className="fixed top-0 z-50 flex items-center justify-between w-full h-20 px-8 py-4 bg-slate-700 text-slate-50 pr-[14rem]">
            ...
            <div className="flex space-x-3 ">
                ...
                <button type="button" className="relative inline-flex items-center p-3 text-sm font-medium text-center text-white rounded-lg bg-slate-700 dark:hover:bg-blue-700">
                    <Bell size={24} className="text-green-600" />
                    <span className="sr-only">Notifications</span>
                    <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-0 dark:border-gray-900">20</div>
                </button>
